...
**Created**: 2025-10-03
**Status**: Draft
**Input**: User description: "Integrate Electron selectively into a Tauri-first monorepo, enabling two patterns: A) Electron sidecar window managed by Tauri; B) Optional Electron module packaged separately and used on demand. Keep footprint small, preserve security posture, and wire exact repo paths/scripts."
